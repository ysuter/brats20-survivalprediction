...
rootdir = "/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/MICCAI_BraTS2020_TrainingData"
...
featdf.to_csv(os.path.join(rootdir, "..", "posfeat_training.csv"), index=False)
