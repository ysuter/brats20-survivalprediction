...
def main(patdir: str):
    ...
    inputpath = "/home/ubelix/artorg/ysuter/BraTS2020/MICCAI_BraTS2020_TestingData"
    ...
    try:
        ...
        ventrdist_t1space = ants.apply_transforms(fi, ventricledistmap, tx["fwdtransforms"], interpolator='linear',
                                                  imagetype=0,
