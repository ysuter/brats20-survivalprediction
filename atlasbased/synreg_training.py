...
def main(inputpath: str):
    ...
    ventricledistpath = "/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/MANAGE/code/MANAGE/brats2020/ventricle_distancemap.nii.gz"
    atlaspath = "/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/MANAGE/code/MANAGE/brats2020/MNI152_T1_1mm_brain.nii.gz"
    ...
    for patdir in tqdm(patdirs):
        ...
        try:
            ...
            ventrdist_t1space = ants.apply_transforms(fi, ventricledistmap, tx, interpolator='linear', imagetype=0,
            ...
            ants.image_write(tx["warpedmovout"], os.path.join("Atlas_t1space.nii.gz"))
            ants.image_write(tx["warpedfixout"], os.path.join("T1_atlasspace.nii.gz"))
            ants.image_write(ventrdist_t1space, os.path.join("ventricledistmap_t1space.nii.gz"))
