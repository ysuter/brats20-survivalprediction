...
iterativecorr.to_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/trainingfeatures_iterativeremoved.csv")
...
plt.tight_layout()
plt.savefig("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/reducedcorr_iterative.png", dpi=400)
plt.show()
