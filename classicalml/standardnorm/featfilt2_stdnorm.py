...
#                       index_col="ID")
inpfeat = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/trainfeat_all_stdnorm.csv",
                      index_col="ID")
...
cind_df.to_csv('/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/concordanceidx_training_nobinduplicates_stdnorm.csv')
