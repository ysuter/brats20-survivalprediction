...
pyrad_trainfeat = pd.read_csv("/media/yannick/MANAGE/BraTS20/brats20_pyradfeatures.csv")

pyrad_nonimaging = pyrad_trainfeat.loc[:, ['ID', 'Age', 'Survival_days', 'Extent_of_Resection']]
pyrad_nonimaging.drop_duplicates(inplace=True, ignore_index=True)
...
posfeat = pd.read_csv("/media/yannick/MANAGE/BraTS20/posfeat_training.csv")
...
trainfeat_all.to_csv("/media/yannick/MANAGE/BraTS20/trainfeat_all.csv", index=None)