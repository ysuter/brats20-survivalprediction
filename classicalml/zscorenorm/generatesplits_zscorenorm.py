...
features = pd.read_csv(
    "/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/trainingfeatures_iterativeremoved_stdnorm.csv",
    index_col="ID")
...
scalerdf.to_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/scalinginfo_zscorenorm.csv")

# put survival info back
featscaled_wsurv = features_nosurv.merge(survival, on="ID")
featscaled_wsurv.to_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/training_scaledfeat_zscorenorm.csv")
