...
def writeresults(outdf, sel_name, clf_name, split, param1, param2, acc, balacc, mse, r2, rho):
    ...
    print(outdf)
    outdf.to_csv(
        "/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_seqprior_regression2qtfm.csv",
        index=False)
...
outdf.to_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_seqprior_regression2qtfm.csv", index=False)
