...
def writeresults(outdf, sel_name, clf_name, split, param1, param2, acc, balacc, mse, r2, rho):
    ...
    print(outdf)
    outdf.to_csv(
        "/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_ageshape_regression_manual.csv",
        index=False)
...
colselect = ['log-sigma-2-0-mm-3D_glszm_GrayLevelNonUniformity edema T1c 40'
 'log-sigma-2-0-mm-3D_glszm_GrayLevelNonUniformity enhancing T1c 40'
 'original_firstorder_90Percentile edema T1 40' 'z_mincet'
 ...
 'original_firstorder_Range enhancing T2 40', 'Age', 'cet_ventrdist']
...
outdf = pd.DataFrame(data=[], columns=["Feature selector", "ML method", "Split", "Parameter1", "Parameter2", "Accuracy",
...
for split in np.arange(numsplits):
    ...
    for sel_name, sel in zip([None], [None]):
...
outdf.to_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_ageshape_regression_manual.csv", index=False)
