...
def main(inputpath: str, outputpath: str):
    ...
    osinfo = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/survival_evaluation.csv")

    # patientlist = list(osinfo["Brats20ID"])
    patientlist = list(osinfo["ID"])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/MICCAI_BraTS2020_ValidationData_onlysurvival",
    ...
    parser.add_argument(
        ...
        default="/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/validation_healthyseginp",
