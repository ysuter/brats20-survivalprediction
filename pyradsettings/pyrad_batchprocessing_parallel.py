...
for nbins in numbins:
  # File variables
  ROOT = os.getcwd()
  PARAMS = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/MANAGE/code/MANAGE/brats2020/pyradsettins/pyradsettings_t1_' + str(nbins) + 'bins.yaml'  # Parameter file
  LOG = os.path.join(ROOT, 'log.txt')  # Location of output log file
  # INPUTCSV = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/brats20_pyradinp.csv'
  INPUTCSV = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/brats20_training_pyradinp_t1.csv'
  OUTPUTCSV = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/brats20_pyradout_training_t1_' + str(nbins) + 'bins.csv'
  ...
  def run(case):
    ...
    try:
      ...
      threading.current_thread().name = case['Patient_Timepoint']

      filename = r'features_' + str(case['Reader']) + '_' + str(case['Patient_Timepoint']) + '.csv'
      ...
      # Extract features
      feature_vector.update(extractor.execute(imageFilepath, maskFilepath, label=int(label)))
      ...
      ptLogger.info('Patient %s read by %s processed in %s', case['Patient_Timepoint'], case['Reader'], delta_t)
    ...
    try:
      with open(INPUTCSV, 'r') as inFile:
        ...
        for row_idx, row in enumerate(cr, start=1):
          ...
          if 'Patient_Timepoint' not in row:
            row['Patient_Timepoint'] = row_idx
...
for nbins in numbins:
  # File variables
  ROOT = os.getcwd()
  PARAMS = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/MANAGE/code/MANAGE/brats2020/pyradsettins/pyradsettings_t2_' + str(nbins) + 'bins.yaml'  # Parameter file
  LOG = os.path.join(ROOT, 'log.txt')  # Location of output log file
  # INPUTCSV = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/brats20_pyradinp.csv'
  INPUTCSV = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/brats20_training_pyradinp_t2.csv'
  OUTPUTCSV = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/brats20_pyradout_training_t2_' + str(nbins) + 'bins.csv'
...
for nbins in numbins:
  # File variables
  ROOT = os.getcwd()
  PARAMS = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/MANAGE/code/MANAGE/brats2020/pyradsettins/pyradsettings_flair_' + str(nbins) + 'bins.yaml'  # Parameter file
  LOG = os.path.join(ROOT, 'log.txt')  # Location of output log file
  # INPUTCSV = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/brats20_pyradinp.csv'
  INPUTCSV = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/brats20_training_pyradinp_flair.csv'
  OUTPUTCSV = '/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/brats20_pyradout_training_flair_' + str(nbins) + 'bins.csv'
