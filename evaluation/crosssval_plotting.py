...
nopriors = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_accnew.csv")

# results with sequence prior
seqprior = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_acc_seqnew.csv")

# results with robustness prior
robprior = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_acc_robnew.csv")

# results with both priors
robseqprior = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_acc_robseqnew.csv")

# results with age, shape and position features
ageshape = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_ageshapepos_class.csv")
...
nopriors_aggr_wide_acc.to_csv(os.path.join(outpath, "nopriors_acc.csv"))
nopriors_aggr_wide_balacc.to_csv(os.path.join(outpath, "nopriors_balacc.csv"))
seqprior_aggr_wide_acc.to_csv(os.path.join(outpath, "seqprior_acc.csv"))
seqprior_aggr_wide_balacc.to_csv(os.path.join(outpath, "seqprior_balacc.csv"))
robprior_aggr_wide_acc.to_csv(os.path.join(outpath, "robprior_acc.csv"))
robprior_aggr_wide_balacc.to_csv(os.path.join(outpath, "robprior_balacc.csv"))
robseqprior_aggr_wide_acc.to_csv(os.path.join(outpath, "robseqprior_acc.csv"))
robseqprior_aggr_wide_balacc.to_csv(os.path.join(outpath, "robseqprior_balacc.csv"))
ageshape_aggr_wide_acc.to_csv(os.path.join(outpath, "ageshape_acc.csv"))
ageshape_aggr_wide_balacc.to_csv(os.path.join(outpath, "ageshape_balacc.csv"))
...
plt.savefig(os.path.join(outpath, "heatmap_noprior_acc.png"), bbox_inches="tight")
plt.show()
fig = plt.figure()
...
plt.savefig(os.path.join(outpath, "heatmap_noprior_balacc.png"), bbox_inches="tight")
plt.show()
...
plt.savefig(os.path.join(outpath, "heatmap_seq_acc.png"), bbox_inches="tight")
plt.show()
fig = plt.figure()
...
plt.savefig(os.path.join(outpath, "heatmap_seq_balacc.png"), bbox_inches="tight")
plt.show()
...
plt.savefig(os.path.join(outpath, "heatmap_rob_acc.png"), bbox_inches="tight")
plt.show()
fig = plt.figure()
...
plt.savefig(os.path.join(outpath, "heatmap_rob_balacc.png"), bbox_inches="tight")
plt.show()
...
plt.savefig(os.path.join(outpath, "heatmap_robseq_acc.png"), bbox_inches="tight")
plt.show()
fig = plt.figure()
...
plt.savefig(os.path.join(outpath, "heatmap_robseq_balacc.png"), bbox_inches="tight")
plt.show()
...
plt.savefig(os.path.join(outpath, "heatmap_ageshape_acc.png"), bbox_inches="tight")
plt.show()
fig = plt.figure()
...
plt.savefig(os.path.join(outpath, "heatmap_ageshape_balacc.png"), bbox_inches="tight")
plt.show()
...
allbest = pd.concat((age_bestcombdata_balacc, noprior_bestcombdata_balacc, seqrior_bestcombdata_balacc,
...
plt.tight_layout()
plt.savefig(os.path.join(outpath, "boxplot_modelcomparison_acc.png"))
plt.show()
...
overallmeanstd.to_csv(os.path.join(outpath, "modelcv_meanstd_acc.csv"))
...
plt.tight_layout()
plt.savefig(os.path.join(outpath, "boxplot_modelcomparison_balacc.png"))
plt.show()
