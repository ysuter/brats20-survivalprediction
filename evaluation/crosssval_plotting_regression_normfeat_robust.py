...
nopriors = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_regression2robust.csv")

# results with sequence prior
seqprior = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_seqprior_regression2robust.csv")

# results with robustness prior
robprior = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_robprior_regression2robust.csv")

# results with both priors
robseqprior = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_robseqprior_regression2robust.csv")
...
nopriors_aggr_wide_acc.to_csv(os.path.join(outpath, "nopriors_acc_regression2robust.csv"))
nopriors_aggr_wide_balacc.to_csv(os.path.join(outpath, "nopriors_balacc_regression2robust.csv"))
seqprior_aggr_wide_acc.to_csv(os.path.join(outpath, "seqprior_acc_regression2robust.csv"))
seqprior_aggr_wide_balacc.to_csv(os.path.join(outpath, "seqprior_balacc_regression2robust.csv"))
robprior_aggr_wide_acc.to_csv(os.path.join(outpath, "robprior_acc_regression2robust.csv"))
robprior_aggr_wide_balacc.to_csv(os.path.join(outpath, "robprior_balacc_regression2robust.csv"))
robseqprior_aggr_wide_acc.to_csv(os.path.join(outpath, "robseqprior_acc_regression2robust.csv"))
robseqprior_aggr_wide_balacc.to_csv(os.path.join(outpath, "robseqprior_balacc_regression2robust.csv"))
ageshape_aggr_wide_acc.to_csv(os.path.join(outpath, "ageshape_acc_regression2robustm.csv"))
ageshape_aggr_wide_balacc.to_csv(os.path.join(outpath, "ageshape_balacc_regression2robust.csv"))
...
plt.savefig(os.path.join(outpath, "heatmap_noprior_acc_regression2robust.png"), bbox_inches="tight")
plt.show()
fig = plt.figure()
...
plt.savefig(os.path.join(outpath, "heatmap_noprior_balacc_regression2robust.png"), bbox_inches="tight")
plt.show()
...
plt.savefig(os.path.join(outpath, "heatmap_seq_acc_regression2robust.png"), bbox_inches="tight")
plt.show()
fig = plt.figure()
...
plt.savefig(os.path.join(outpath, "heatmap_seq_balacc_regression2robust.png"), bbox_inches="tight")
plt.show()
...
plt.savefig(os.path.join(outpath, "heatmap_rob_acc_regression2robust.png"), bbox_inches="tight")
plt.show()
fig = plt.figure()
...
plt.savefig(os.path.join(outpath, "heatmap_rob_balacc_regression2robust.png"), bbox_inches="tight")
plt.show()
...
plt.savefig(os.path.join(outpath, "heatmap_robseq_acc_regression2robust.png"), bbox_inches="tight")
plt.show()
fig = plt.figure()
...
plt.savefig(os.path.join(outpath, "heatmap_robseq_balacc_regression2robust.png"), bbox_inches="tight")
plt.show()
...
plt.savefig(os.path.join(outpath, "heatmap_ageshape_acc_regression2robust.png"), bbox_inches="tight")
plt.show()
fig = plt.figure()
...
plt.savefig(os.path.join(outpath, "heatmap_ageshape_balacc_regression2robust.png"), bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(outpath, "boxplot_modelcomparison_acc_regression2robust.png"))
plt.show()
...
overallmeanstd.to_csv(os.path.join(outpath, "modelcv_meanstd_acc_regression2robust.csv"))
...
plt.tight_layout()
plt.savefig(os.path.join(outpath, "boxplot_modelcomparison_balacc_regression2robust.png"))
plt.show()
