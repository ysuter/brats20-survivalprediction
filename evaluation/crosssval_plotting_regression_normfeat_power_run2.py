...
seqprior = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_regression2power.csv")

# results with robustness prior
robprior = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_regression2power_run2.csv")

# results with both priors
robseqprior = pd.read_csv("/media/yannick/c4a7e8d3-9ac5-463f-b6e6-92e216ae6ac0/BRATS/BraTS2020/featsel_outputs/cvresults_robseqprior_regression2power.csv")
...
plt.tight_layout()
plt.savefig(os.path.join(outpath, "boxplot_modelcomparison_acc_TMP.png"))
plt.show()
...
overallmeanstd.to_csv(os.path.join(outpath, "modelcv_meanstd_acc_TMP.csv"))
...
allbest.to_csv("/home/yannick/Dropbox/Doktorat/Conferences/MICCAI20/BraTS2020/powertfm.csv")

plt.ylim([0, 1])
plt.title("Regression Balanced Accuracy, 10-fold cross-validation", fontdict={"fontweight": "bold"})
plt.tight_layout()
plt.savefig(os.path.join(outpath, "boxplot_modelcomparison_balacc_TMP.png"))
plt.show()
